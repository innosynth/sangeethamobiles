...
from backend.Feedback import FeedbackModel
...
def extract_feedbacks(db, user_id, role, start_date, end_date):
    ...
    for user in users:
        user_feedbacks = (
            ...
            .filter(
                FeedbackModel.user_id == user.user_id,
        ...
        feedbacks.extend(user_feedbacks)
